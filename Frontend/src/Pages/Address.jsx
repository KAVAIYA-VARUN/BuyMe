...
const Address = () =>
{
    ...
    const { backendUrl, token, setCartItems, setToken, cartItems } = useContext(ShopContext);
        ...
        try
        {
            ...
            if(response.data.success)
            {
                ...
                if(hasItems)
                {
                    setTimeout(() =>
                    {
                        navigate("/cart");  // sends user back to cart with all previous items
                    }, 1000);
                }
            }
            else
    ...
    return (
        <>
        <div className="min-h-screen bg-[#F5E8DF] dark:bg-gray-900">
