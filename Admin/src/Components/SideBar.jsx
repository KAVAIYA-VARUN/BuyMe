  ...
  return (
    ...
    <div className='w-[18%] min-h-screen border-r-2 border-gray-600'>
        <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15p'>
            ...
            <NavLink className="flex items-center gap-3 border border-gray-600 border-r-0 px-3 py-2 rounded-l bg-gray-400 text-black" to="/users">
            <img src={Assets.all_users} className='w-5 h-5' alt="" />
