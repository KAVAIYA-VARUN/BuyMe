...
const adminLogin = async (req,res) =>
{
    try
    {
        ...
        if(email === process.env.ADMIN_EMAIL && password === process.env.ADMIN_PASSWORD)
        {
            ...
            return res.json({success: true, token, message: "LoggedIn Successfully"});
        }
        else
        {
    ...
    {
        console.log(error);
        return res.json({success: false, message: "Error Admin Not Found"});
    }
}
...
const addAddress = async (req,res) => 
{
    ...
    {
        console.log(error);
        return res.json({ success: false, message: "Failed to Add the Address" });
    }
}
